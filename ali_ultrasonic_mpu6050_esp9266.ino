...
#define RX 10
#define TX 11
String AP = "HACK@CEWIT";       // CHANGE ME
String PASS = "cewit@1500!"; // CHANGE ME
String API = "C3MDGHMWCWEHOS75";   // CHANGE ME
String API2 = "9YF02QA80GGHWID9";   // CHANGE ME
 ...
 */
 ...
 String getData = "GET /update?api_key="+ API +"&field1="+String(distance1)+"&field2="+String(distance2)+"&field3="+String(distance3); 
 //String getData1 ="GET /update?api_key="+ API2 +"&field1="+String(accel_angle_x)+"&field2="+String(accel_angle_y)+"&field3="+String(accel_angle_z)+"&field4="+String(gyro_angle_x)+"&field5="+String(gyro_angle_y)+"&field6="+String(gyro_angle_z)+"&field7="+String(dt);
